(() => {
    ...
    const headerText = document.querySelector('.grab-header_text');
    ...
    const updateHeader = () => {
        ...
        if (mobileToolbar) {
            ...
            const isStuck = Math.abs(toolbarRect.top - headerBottom) < STUCK_THRESHOLD && progress > 0.95;
            mobileToolbar.classList.toggle('with-border', isStuck);
        }
    };
